  ...
  const importMethods = [
    {
      ...
      href: `/leads/import/csv?campaign=${encodeURIComponent(campaignName)}`
    },
    {
      id: 'finder',
      ...
      href: `/leads/import/finder?campaign=${encodeURIComponent(campaignName)}`
    },
    {
      id: 'manual',
      ...
      href: `/leads/import/manual?campaign=${encodeURIComponent(campaignName)}`
    },
    {
      id: 'sheets',
      ...
      href: `/leads/import/sheets?campaign=${encodeURIComponent(campaignName)}`
    }
  ]
